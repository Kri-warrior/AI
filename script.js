...
function getAIResponse(userMessage) {
  const responses = {
    ...
    "when does national science day celebrated": "February 28",
    ...
    "which animal never drinks water in his entire life": "Kangaroo rat",
    ...
    "what are the benefits of computers":"High Speed,Storage,Multitasking and more.",
    ...
    "how is petroleum formed":"Petroleum was formed from dead organisms that got buried in the sea millions of years ago. These dead bodies got covered with layers of sand and clay. Lack of air, high temperature, and high pressure transformed these dead organisms into petroleum and natural gas.",
    ...
    "explain the concept of probability":"Probability is a mathematical concept used to quantify the likelihood or chance of an event occurring. It is a measure of uncertainty or randomness in various situations. Probability is expressed as a number between 0 and 1, where 0 represents an event that is impossible, 1 represents an event that is certain, and values between 0 and 1 represent the degree of likelihood.",
